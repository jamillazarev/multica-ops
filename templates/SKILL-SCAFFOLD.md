...
*Used by the skill lifecycle (`/mops skill create`, the guide, tooling skills). A skill made
...
one pointer line. Compression (`/mops skill optimize`) is the second resort, deletion the
