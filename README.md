...
**26 stratified eval scenarios** — from a job too small to deserve a company to an import
...
| [evals/](evals/) | the 26 scenarios, plus `runs/` — the recorded verdicts per release |
