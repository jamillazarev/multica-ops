...
| **[STACKS.md](../../STACKS.md)** | **the first stop whenever anything is to be connected, chosen or recommended — before any search** · choosing any tool/service/library — services, AI-fluent libraries, audio & DSP, testing, security, reference galleries. **Searched by need, never read whole**: it is the longest file here and one row is usually the whole answer |
