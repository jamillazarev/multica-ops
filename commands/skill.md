---
description: The toolkit's lifecycle — create a skill from a repeated routine, screen and trim an imported one, compress fail-closed, or release a proven skill into its own repo.
---

Load and follow the **multica-ops** skill (SKILL.md), executing its `/skill` flow
