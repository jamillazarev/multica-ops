...
language, not the changelog's:

- **what changed** — grouped by what it means for them, not by file;
- **why it helps** — the problem each change removes, in one line;
- **what to do differently**, if anything — a new command worth trying, a habit that changed,
  a default that moved. Most entries need no action; say so rather than inventing homework.
